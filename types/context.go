...
func (c Context) MultiStore() CacheMultiStore                { return c.ms }
...
func NewContext(ms CacheMultiStore, header tmproto.Header, isCheckTx bool, logger log.Logger) Context {
...
func (c Context) WithMultiStore(ms CacheMultiStore) Context {
	c.ms = ms
	return c
}
...
// CloneMultiStore returns a new Context with a cloned cached multi-store.
func (c Context) CloneMultiStore() Context {
	return c.WithMultiStore(c.ms.Clone())
}
